...
const FEED_TOGGLES: ToggleDefinition[] = [
  ...
  },
  {
    ...
    label: {
      en: 'Fullscreen slash commands view',
      fr: 'Vue plein écran des commandes slash',
    },
    description: {
...
export function DisplayTab() {
  ...
  const fullscreenSlash = useSetting(SETTINGS_KEYS.DISPLAY_FULLSCREEN_SLASH_COMMAND, 'false')
  ...
  const localValues: Record<string, string> = {
    ...
    [SETTINGS_KEYS.DISPLAY_FULLSCREEN_SLASH_COMMAND]: fullscreenSlash.value,
